...
include 'koneksi.php';
    ...
    $id = $_GET['id'];
    $result = $conn->query("SELECT * FROM tb_anggota WHERE id_anggota = $id");
                            ...
                            <form action="" method="POST">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <div class="form-floating mb-3 mb-md-0">
                                            <input class="form-control" id="inputFirstName" type="text" name="nama" value="<?= $row['nama']; ?>" required />
                                            <label for="inputFirstName">Masukkan nama</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input class="form-control" id="inputLastName" type="text" name="kelas" value="<?= $row['kelas']; ?>" required />
                                ...
                                <div class="col-md-3">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputFirstName" type="text" name="jk" value="<?= $row['jk']; ?>" required />
                                        <label for="inputFirstName">Masukkan jenis kelamin</label>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputFirstName" type="text" name="alamat" value="<?= $row['alamat']; ?>" required />
