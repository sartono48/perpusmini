...
$result = $conn->query("SELECT tb_buku.judul, tb_anggota.nama, tgl_pinjam, tgl_kembali, id_pinjam FROM tb_pinjam, tb_buku, tb_anggota 
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php while($row = mysqli_fetch_array($result)){ ?>                                      
                                            ...
                                            <td>
                                                <a href="edit.php?id=<?= $row['id_pinjam']; ?>">Edit</a> |
                                                <a href="delete.php?id=<?= $row['id_pinjam']; ?>" Onclick="return confirm('Yakin ingin menghapus?')">Hapus</a> |
                                                <a href="kembali.php?id=<?= $row['id_pinjam']; ?>">Kembali</a>
                                            </td>
                                        <tr>
                                        <?php } ?>                   
                                    </tbody>
